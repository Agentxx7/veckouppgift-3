"""Plot merge sort benchmark results.

Reads benchmark_results/merge_sort.csv (columns: n, time_ms) and
saves a line/scatter plot showing how the runtime grows with n to
benchmark_results/merge_sort.png.
"""
...
CSV_PATH = BASE_DIR / "benchmark_results" / "merge_sort.csv"
PNG_PATH = BASE_DIR / "benchmark_results" / "merge_sort.png"
...
def plot_results(n_values, time_values, output_path):
    ...
    ax.set_title("Merge sort performance")
    ax.grid(True)
